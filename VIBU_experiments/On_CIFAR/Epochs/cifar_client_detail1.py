...
plt.figure()
plt.plot(x, y_bfu_back_acc, color='orange',  marker='x',  label='VBU',linewidth=4,  markersize=10)
plt.plot(x, y_ss_back_acc, color='g',  marker='*',  label='VIBU-SS',linewidth=4, markersize=10)
