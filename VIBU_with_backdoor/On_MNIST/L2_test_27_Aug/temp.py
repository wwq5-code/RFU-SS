...
def vib_learning(vibi, dataloader_full, reconstruction_function, args, train_loader):
...
vibi = vib_learning(vibi, dataloader_full,reconstruction_function, args, train_loader)

print("retraining")
vibi_r, lr = init_vibi(args.dataset)
vibi_r.to(args.device)
vibi_r = vib_learning(vibi_r, dataloader_remain,reconstruction_function, args, train_loader)
